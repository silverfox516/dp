...
public:
 virtual MyIterator<Item>* createIterator() const = 0;
private:
};
...
public:
 ...
 void popBack();
 Item get(long pos);
 virtual MyIterator<Item>* createIterator() const;
...
template <typename Item>
MyIterator<Item>* MyList<Item>::createIterator() const {
